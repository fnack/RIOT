...
/* TODO: Remove later */
static kernel_pid_t helper_pid;
...
/* TODO: Remove later */
static void print_packet(void *buffer, size_t length);
    ...
    while (1) {
        ...
        switch (msg_rcvd.type) {
            ...
            case NETAPI_MSG_TYPE:
                ...
                LED_RED_TOGGLE; /* TODO: Remove later */
                ...
                if (cmd->type == NETAPI_CMD_RCV) {
                    ...
                    nhdp_reader_handle_packet(helper_pid,
