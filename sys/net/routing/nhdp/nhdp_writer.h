 ...
 * @param[in] value         Encoded incoming link metric value
 * @param[in] value         Encoded outgoing link metric value
 */
void nhdp_writer_add_addr(struct rfc5444_writer *wr, nhdp_addr_t *addr,
        enum rfc5444_addrtlv_iana type, uint8_t value, uint16_t metric_in, uint16_t metric_out);
